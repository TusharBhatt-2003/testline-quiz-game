    ...
    <div className="flex  h-screen justify-center">
      {!showQuiz ? (
        ...
        <div className='relative'>
         ...
         <h1 className="text-2xl md:text-4xl text-center font-semibold text-[#168E8C]">{quizData?.title}</h1>
            ...
            <div className='h-[75vh] w-[95vw] md:w-[80vw] flex flex-col md:h-full'>
              ...
              />
               <div className='text-white text-center mt-5'>
                 <p>you have answered {Object.keys(answers).length}/{quizData.questions.length} questions</p>
                </div>
