...
const QuizCompletionPopup: React.FC<QuizCompletionPopupProps> = ({ showPopup, onClose }) => {
  ...
  return (
    ...
    <Btn btnText="See Result" href='/result'/>
        <button className="bg-neutral-700 text-neutral-500 px-4 py-2 rounded-lg" onClick={onClose}>
          Cancel
        </button>
    </div>
      </div>
