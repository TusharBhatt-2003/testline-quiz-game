...
export default function Page() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-b  text-white p-6">
      ...
      className="text-4xl font-bold mb-8">{quizData.title}</motion.h1>

      <motion.div
       initial={{ opacity: 1, scale: .5, y: 10, }}
      ...
      className="bg-neutral-900 flex flex-col text-white rounded-lg p-8 shadow-xl  md:w-2/3">
        <div className="mb-6">
          ...
          <p className="text-lg mb-2">Topic: <span className="text-teal-400">{quizData.topic}</span></p>
          <p className="text-lg mb-2">Number of Questions: <span className="text-teal-400">{quizData.questions.length}</span></p>
          <p className="text-lg mb-2">Duration: <span className="text-teal-400">{quizData.duration} minutes</span></p>
          <p className="text-lg mb-2">Marking System:</p>
          <ul className="list-inside list-disc pl-4 text-lg">
            <li>Correct Answer: <span className="text-teal-400">{quizData.correct_answer_marks} marks</span></li>
            <li>Incorrect Answer: <span className="text-teal-400">-{quizData.negative_marks} marks</span></li>
          </ul>
        </div>
